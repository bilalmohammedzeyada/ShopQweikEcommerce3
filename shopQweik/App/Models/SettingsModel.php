...
class SettingsModel extends Model
{
    ...
    public function updateSettings()
    {
        ...
        $keys = ['site_name', 'site_email', 'site_status', 'site_close_msg', 'phone', 'gifts', 'shipments', 'msg', 'about', 'price_shipments_pay_hand', 'discount_price', 'shipments_price', 'fb','tw','snap','tube','ins','wht', 'keywords','description'];
