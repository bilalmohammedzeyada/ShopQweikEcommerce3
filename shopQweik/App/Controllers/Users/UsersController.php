...
class UsersController extends Controller
{
    ...
    */
    public function index()
    {
        ...
        $view = $this->view->render('users/users/list', $data);
    ...
    */
    public function submit()
    {
        ...
        if ($this->isValid()) {
            ...
            $json['redirectTo'] = $this->url->link('/users/users');
        } else {
    ...
    private function form($user = null)
    {
        if ($user) {
            ...
            $data['action'] = $this->url->link('/users/users/save/' . $user->id);
            ...
            $data['action'] = $this->url->link('/users/users/submit');
        ...
        return $this->view->render('users/users/form', $data);
    }
