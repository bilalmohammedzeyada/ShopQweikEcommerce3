...
class UsersGroupsController extends Controller
{
    ...
    */
    public function index()
    {
        ...
        $view = $this->view->render('users/users-groups/list', $data);
    ...
    */
    public function submit()
    {
        ...
        if ($this->isValid()) {
            ...
            $json['redirectTo'] = $this->url->link('/users/users-groups');
        } else {
    ...
    private function form($usersGroup = null)
    {
        if ($usersGroup) {
            ...
            $data['action'] = $this->url->link('/users/users-groups/save/' . $usersGroup->id);
            ...
            $data['action'] = $this->url->link('/users/users-groups/submit');
        ...
        return $this->view->render('users/users-groups/form', $data);
    }
