...
class CategoriesController extends Controller
{
    ...
    */
    public function index()
    {
        ...
        $view = $this->view->render('users/categories/list', $data);
    ...
    */
    public function submit()
    {
        ...
        if ($this->isValid()) {
            ...
            $json['redirectTo'] = $this->url->link('/users/categories');
        } else {
    ...
    private function form($category = null)
    {
        if ($category) {
            ...
            $data['action'] = $this->url->link('/users/categories/save/' . $category->id);
            ...
            $data['action'] = $this->url->link('/users/categories/submit');
        ...
        return $this->view->render('users/categories/form', $data);
    }
