...
class PostsController extends Controller
{
    ...
    */
    public function index()
    {
        ...
        $view = $this->view->render('users/posts/list', $data);
    ...
    */
    public function submit()
    {
        ...
        if ($this->isValid()) {
            ...
            $json['redirectTo'] = $this->url->link('/users/posts');
        } else {
    ...
    private function form($post = null)
    {
        if ($post) {
            ...
            $data['action'] = $this->url->link('/users/posts/save/' . $post->id);
            ...
            $data['action'] = $this->url->link('/users/posts/submit');
        ...
        return $this->view->render('users/posts/form', $data);
    }
