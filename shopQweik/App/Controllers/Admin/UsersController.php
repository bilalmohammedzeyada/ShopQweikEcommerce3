    ...
    */
    public function submit()
    {
        ...
        if ($this->isValid()) {
            ...
            $json['success'] = 'تم إضافة عضو جديد بنجاح';
    ...
    */
    public function save($id)
    {
        ...
        if ($this->isValid($id)) {
            ...
            $json['success'] = 'تم تحديث بيانات العضو بنجاح';
    ...
    public function delete($id)
    {
        ...
        if (! $usersModel->exists($id) OR $id == 1 OR $id == 2) {
            return $this->url->redirectTo('/404');
        }

        $usersModel->delete($id);

        $json['success'] = 'تم حذف العضو بنجاح';
    ...
    {
        $this->validator->required('first_name', 'الاسم الأول مطلوب');
        $this->validator->required('last_name', 'اسم العائلة مطلوب');
        ...
        if (is_null($id)) {
            ...
            $this->validator->required('password')->minLen('password', 8)->match('password', 'confirm_password', 'يجب ان تتطابق كلمات المرور');
