...
class SCategoriesController extends Controller
{
    ...
    */
    public function index()
    {
        ...
        $view = $this->view->render('admin/scategories/list', $data);
    ...
    */
    public function submit()
    {
        ...
        if ($this->isValid()) {
            ...
            $this->load->model('Categories')->screate();

            $json['success'] = 'Category Has Been Created Successfully';

            $json['redirectTo'] = $this->url->link('/admin/scategories');
        } else {
    ...
    private function form($category = null)
    {
        if ($category) {
            ...
            $data['action'] = $this->url->link('/admin/scategories/save/' . $category->id);
            ...
            $data['action'] = $this->url->link('/admin/scategories/submit');
        ...
        return $this->view->render('admin/scategories/form', $data);
    }
