        ...
        <div class="main-container col2-left-layout">
			...
			<div class="row clearfix">
				<div class="grid_9 col-main">
										<div id="algolia-autocomplete-container" class="mangolia"></div><div class="my-account">
										<script>
    /* var baseUrl = 'https://www.goldenscent.com/';
    Validation.add('validate-gs-phone', 'الرجاء إدخال رقم هاتف صحيح', function(value) {
        var result = window.customValidator.validatePhone(value);
        return result.valid;
    });
    Validation.add('validate-gs-phone-optional', 'الرجاء إدخال رقم هاتف صحيح', function(value) {
        var result = window.customValidator.validatePhone(value);
        return result.valid || value == '';
    }); */
</script><div class="page-title">
    <h1>تغيير معلومات الحساب</h1>
</div>
<form action="<?php echo $action; ?>" method="post" class="form">
	<div id="form-results"></div>
    <div class="fieldset">
        <input name="form_key" type="hidden" value="AizkxeXcbeE0YbWW"><h2 class="legend">معلومات الحساب</h2>
        <ul class="form-list"><li class="fields">
                <div class="customer-name">
    <div class="field name-firstname">
        <label for="firstname" class="required"><em>*</em>الإسم الأول</label>
        <div class="input-box">
            <input type="text" id="first_name" name="first_name" value="<?php echo $first_name; ?>" title="الإسم الأول" maxlength="255" class="input-text required-entry"></div>
    </div>
    <div class="field name-lastname">
        <label for="lastname" class="required"><em>*</em>الإسم الأخير</label>
        <div class="input-box">
            <input type="text" id="last_name" name="last_name" value="<?php echo $last_name; ?>" title="الإسم الأخير" maxlength="255" class="input-text required-entry"></div>
    </div>
</div>
            </li>
                    ...
                    <input type="hidden" name="users_group_id" class="form-control" id="users_group_id" value="<?php echo $users_group_id; ?>" />
                
         
            <li class="fields">
                <div class="field">
                    <label for="mobile_number" class="required"><em>*</em>رقم الهاتف</label>
                    <div class="input-box" style="width:100%">
                        <input readonly style="width:10%" maxlength="4" type="text" name="mobile_country_code" id="mobile_country_code" value="<?php echo $co_code1; ?>" class="input-text countryCode">
						<input style="width:67%" maxlength="10" type="text" id="mobile_number" value="<?php echo $mobile_number; ?>" name="mobile_number" title="رقم الهاتف" class="input-text validate-length maximum-length-10 minimum-length-9 validate-digits validate-gs-phone required-entry">
					</div>
                </div>
                <div class="field">
                    <label for="alternative_number">رقم الهاتف البديل</label>
                    <div class="input-box" style="width:100%">
                        <input readonly style="width:10%" maxlength="4" type="text" id="alternative_country_code" name="alternative_country_code" value="<?php echo $co_code2; ?>" class="input-text countryCode">
						<input style="width:67%" maxlength="10" type="text" id="alternative_number" name="alternative_number" value="<?php echo $alternative_number; ?>" title="رقم الهاتف البديل" class="input-text validate-length maximum-length-10 minimum-length-9 validate-digits validate-gs-phone-optional">
					</div>
                </div>
            </li>
            <li>
                <label for="e-mail" class="required"><em>*</em>عنوان البريد الالكتروني</label>
                <div class="input-box">
                    <input type="text" name="email" id="email" value="<?php echo $email; ?>" title="عنوان البريد الالكتروني" class="input-text required-entry validate-email"></div>
            </li>
                            <li><label for="month">تاريخ الميلاد</label>
<div class="input-box customer-dob">
	<select id="sDay" name="sDay" rel="day" class="dateselect">
	
	<option value="">اليوم</option>
	<option value="<?php echo $sDay; ?>" selected><?php echo $sDay; ?></option>
	
	<option value="01">1</option><option value="02">2</option><option value="03">3</option><option value="04">4</option><option value="05">5</option><option value="06">6</option><option value="07">7</option><option value="08">8</option><option value="09">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option><option value="31">31</option></select><select id="sMonth" name="sMonth" rel="month" class="dateselect">
	<option value="">الشهر</option>
	<option value="<?php echo $sMonth; ?>" selected><?php echo $sMonth; ?></option>
	
	<option value="01">January</option><option value="02">February</option><option value="03">March</option><option value="04">April</option><option value="05">May</option><option value="06">June</option><option value="07">July</option><option value="08">August</option><option value="09">September</option><option value="10">October</option><option value="11">November</option><option value="12">December</option></select><select id="sYear" name="sYear" rel="year" class="dateselect">
	
	<option value="">السنة</option>
	<option value="<?php echo $sYear; ?>" selected><?php echo $sYear; ?></option>
	
	<option value="2009">2009</option><option value="2008">2008</option><option value="2007">2007</option><option value="2006">2006</option><option value="2005">2005</option><option value="2004">2004</option><option value="2003">2003</option><option value="2002">2002</option><option value="2001">2001</option><option value="2000">2000</option><option value="1999">1999</option><option value="1998">1998</option><option value="1997">1997</option><option value="1996">1996</option><option value="1995">1995</option><option value="1994">1994</option><option value="1993">1993</option><option value="1992">1992</option><option value="1991">1991</option><option value="1990">1990</option><option value="1989">1989</option><option value="1988">1988</option><option value="1987">1987</option><option value="1986">1986</option><option value="1985">1985</option><option value="1984">1984</option><option value="1983">1983</option><option value="1982">1982</option><option value="1981">1981</option><option value="1980">1980</option><option value="1979">1979</option><option value="1978">1978</option><option value="1977">1977</option><option value="1976">1976</option><option value="1975">1975</option><option value="1974">1974</option><option value="1973">1973</option><option value="1972">1972</option><option value="1971">1971</option><option value="1970">1970</option><option value="1969">1969</option><option value="1968">1968</option><option value="1967">1967</option><option value="1966">1966</option><option value="1965">1965</option><option value="1964">1964</option><option value="1963">1963</option><option value="1962">1962</option><option value="1961">1961</option><option value="1960">1960</option><option value="1959">1959</option><option value="1958">1958</option><option value="1957">1957</option><option value="1956">1956</option><option value="1955">1955</option><option value="1954">1954</option><option value="1953">1953</option><option value="1952">1952</option><option value="1951">1951</option><option value="1950">1950</option><option value="1949">1949</option><option value="1948">1948</option><option value="1947">1947</option><option value="1946">1946</option><option value="1945">1945</option><option value="1944">1944</option><option value="1943">1943</option><option value="1942">1942</option><option value="1941">1941</option><option value="1940">1940</option><option value="1939">1939</option><option value="1938">1938</option><option value="1937">1937</option><option value="1936">1936</option><option value="1935">1935</option><option value="1934">1934</option><option value="1933">1933</option><option value="1932">1932</option><option value="1931">1931</option><option value="1930">1930</option><option value="1929">1929</option><option value="1928">1928</option><option value="1927">1927</option><option value="1926">1926</option><option value="1925">1925</option><option value="1924">1924</option><option value="1923">1923</option><option value="1922">1922</option><option value="1921">1921</option><option value="1920">1920</option><option value="1919">1919</option><option value="1918">1918</option><option value="1917">1917</option><option value="1916">1916</option><option value="1915">1915</option><option value="1914">1914</option><option value="1913">1913</option><option value="1912">1912</option><option value="1911">1911</option><option value="1910">1910</option></select><div class="dob-full" style="display:none;">
        <div class="dob-day"><input type="hidden" id="day" name="day" value="05"></div>
        <div class="dob-month"><input type="hidden" id="month" name="month" value="07"></div>
        <div class="dob-year"><input type="hidden" id="year" name="year" value="1982"></div>
        <input type="hidden" id="dob" name="dob"></div>
    <div class="validation-advice" style="display:none;"></div>
  </div>
<script type="text/javascript">
//<![CDATA[

v/* ar customer_dob = new Varien.DOB('.customer-dob', false, '%e‏/%m‏/%Y');
function updateDobFields(){
	var dayFieldVal = jQuery("#day").val(),
		monFieldVal = jQuery("#month").val(),
		yearFieldVal= jQuery("#year").val();

	jQuery( "#dob" ).val("");
	if (dayFieldVal && monFieldVal && yearFieldVal){
					jQuery( "#dob" ).val([dayFieldVal,monFieldVal,yearFieldVal].join("/"));
			}
}
...
<li><label for="gender">الجنس</label>
	<div class="input-box">
		<select id="gender" name="gender" title="الجنس">
			<option value="<?php echo $gender; ?>" selected><?php 
			if($gender == 'male' ){
				echo 'ذكر';
			} else {
				echo 'أنثى';
			...
			<option value="female">أنثى</option>
                    ...
                    <li>
                <label for="current_password" class="required"><em>*</em>كلمة المرور الحالية</label>
                <div class="input-box">
                    <!-- This is a dummy hidden field to trick firefox from auto filling the password -->
                    <input type="text" class="input-text no-display" name="dummy" id="dummy"><input type="password" title="كلمة المرور الحالية" class="input-text required-entry" name="current_password" id="current_password"></div>
            </li>
            <li class="control">
                <input type="checkbox" name="change_password" id="change_password" value="1" onclick="setPasswordForm(this.checked)" title="تغيير كلمة المرور" class="checkbox"><label for="change_password">تغيير كلمة المرور</label>
            </li>
        </ul></div>
    <div class="fieldset" style="display:none;">
        <h2 class="legend">تغيير كلمة المرور</h2>
        <ul class="form-list"><li class="fields">
                <div class="field">
                    <label for="password" class="required"><em>*</em>كلمة مرور جديدة</label>
                    <div class="input-box">
                        <input type="password" title="كلمة مرور جديدة" class="input-text required-entry validate-password" name="password" id="password"></div>
                </div>
                <div class="field">
                    <label for="confirmation" class="required"><em>*</em>تأكيد كلمة المرور الجديدة</label>
                    <div class="input-box">
                        <input type="password" title="تأكيد كلمة المرور الجديدة" class="input-text required-entry validate-cpassword" name="confirmation" id="confirmation"></div>
                </div>
            </li>
        </ul></div>
    <div class="buttons-set">
        ...
        <button type="button" title="حفظ" class="button btn btn-info submit-btn"><span><span>حفظ</span></span></button>
    </div>
</form>
<script type="text/javascript">
/* //<![CDATA[
 ...
 */
    ...
    <div class="block-title">
        <strong><span><i class="icon-user"></i>fayez almalki</span></strong>
    </div>
    <div class="block-content">
        <ul><li><a href="https://www.goldenscent.com/customer/address/">العنوان</a></li>
                                                                                <li class="current"><strong>معلومات الحساب</strong></li>
                                                                                <li><a href="https://www.goldenscent.com/sales/order/history/">مشترياتي</a></li>
                                                                                <li><a href="https://www.goldenscent.com/review/customer/">مراجعات المنتجات</a></li>
                                                                                <li><a href="https://www.goldenscent.com/newsletter/manage/">اشتراكات النشرات الاخبارية</a></li>
                                        <li class="last"><a href="/customer/account/logout">تسجيل الخروج</a></li>
        </ul></div>
    ...
    <div class="block-content">
                                <ul class="closed-default" id="categories-accordion"><li class="level0 nav-1 level-top first parent">
...
</ul></li><li class="level0 nav-2 level-top parent">
...
<span>تخفيضات نهاية عام 2018</span>
    ...
    <form action="https://www.goldenscent.com/newsletter/subscriber/new/" method="post" id="newsletter-validate-detail_62">
        <div class="block-content">
            ...
            <div class="input-box">
               <input type="text" name="email" id="newsletter_62" title="الاشتراك بنشرتنا البريدية" class="input-text required-entry validate-email" placeholder="الاشتراك بنشرتنا البريدية"></div>
            <div class="actions">
    ...
    <script type="text/javascript">
    //<![CDATA[
        var newsletterSubscriberFormDetail = new VarienForm('newsletter-validate-detail_62');
    //]]>
	if(jQuery('.block-subscribe').parents('#popup-block').length) {
		jQuery('#popup-block .block-subscribe .actions button.button').on('click', function(){
			...
			setTimeout(function(){
				if(!button.parent().find('input#newsletter_62').hasClass('validation-failed')){
