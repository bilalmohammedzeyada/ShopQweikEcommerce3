  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo url('/users'); ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li class="active">
          ...
          <div class="col-sm-12">
              <div class="box box-danger" id="users-list">
                <div class="box-header with-border">
                  ...
                  <button class="btn btn-danger pull-right open-popup" type="button" data-modal-target="#add-user-form" data-target="<?php echo url('/users/users/add'); ?>">Add New User</button>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                  <div id="results"></div>
                    ...
                    <?php foreach ($users AS $user) { ?>
                        <tr>
                          ...
                          <td style="vertical-align: middle;">
                            <button type="button" data-target="<?php echo url('users/users/edit/' . $user->id) ?>" data-modal-target="#edit-user-<?php echo $user->id; ?>" class="btn btn-primary open-popup">
                                Edit
