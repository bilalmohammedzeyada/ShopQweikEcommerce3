  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">مجموعات الاعضاء</li>
      </ol>
    </section>
          ...
          <div class="col-sm-12">
              <div class="box box-danger" id="users-list">
                <div class="box-header with-border">
                  <h3 class="box-title">إدارة مجموعات الأعضاء</h3>
                  <button class="btn btn-danger pull-right open-popup" type="button" data-modal-target="#add-users-group-form" data-target="<?php echo url('/admin/users-groups/add'); ?>">إضافة عضو جديد الى مجموعة </button>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                  <div id="results"></div>
