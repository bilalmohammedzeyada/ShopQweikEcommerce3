...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">سجل دخولك لنقم ببدا جلسة</p>
    ...
    <form action="<?php echo url('/admin/login/submit'); ?>" method="post" id="login-form">
      ...
      <div class="form-group has-feedback">
        <input type="email" class="form-control" name="email" placeholder="الرجاء قم بادخال البريد الالكتروني" required="required">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" name="password" class="form-control" placeholder="الرجاء قم بادخال كلمة المرور" required="required">
