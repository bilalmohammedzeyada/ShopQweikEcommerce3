...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h4 class="modal-title" id="myModalLabel">تحديث ملف تعريف المستخدم</h4>
    </div>
    <div class="modal-body">
        ...
        <div class="form-group col-sm-6">
          ...
          <input type="text" class="form-control" name="first_name" id="first_name" value="<?php echo $user->first_name; ?>" placeholder="الاسم الاول">
        </div>
        <div class="form-group col-sm-6">
          <label for="last_name">اسم العائلة</label>
          <input type="text" class="form-control" name="last_name" id="last_name" value="<?php echo $user->last_name; ?>" placeholder="اسم العائلة">
        </div>

        <div class="form-group col-sm-6">
          <label for="email">البريد الالكتروني</label>
          <input type="email" class="form-control" name="email" id="email" value="<?php echo $user->email; ?>" placeholder="البريد الالكتروني">
        </div>
        ...
        <div class="form-group col-sm-6">
            ...
            <input type="text" name="birthday" placeholder="تاريخ الميلاد" class="form-control" value="<?php echo $user->birthday; ?>" />
        </div>
        ...
        <div class="form-group col-sm-6">
            ...
            <select class="form-control" id="gender" name="gender">
                ...
                <option value="female" <?php echo $user->gender == 'female' ? 'selected': false; ?>>أنثى</option>
            </select>
        </div>
