                  ...
                  <table class="table table-bordered">
					...
					<!--`id`, `first_name`, `last_name`, `email`, `country`, `city`, `region`, `street`, `building_number`, `post_code`, `co_country`, `mobile`, `shipping_method`, `payment_method`, `total_price`, `product_title`, `price`, `weight`, `quantity`, `product_id`, `code`, `created`, `status`, `user_id` -->
                        <tr>
                          ...
                          <td style="vertical-align: middle;">
                            <button type="button" data-target="<?php echo url('admin/sales/edit/' . $sale->id) ?>" data-modal-target="#edit-sale-<?php echo $sale->id; ?>" class="btn btn-primary open-popup">
                                تعديل
                                <span class="fa fa-pencil"></span>
                            </button>
                            <button data-target="<?php echo url('admin/sales/delete/' . $sale->id) ?>" class="btn btn-danger delete">
                                حذف
